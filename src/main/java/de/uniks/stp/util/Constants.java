...
public class Constants {
    ...
    // Client
    public static final String REST_SERVER_URL = "http://192.168.188.42:8080"; // https://ac.uniks.de
    ...
    // AudioStream
    public static String AUDIO_STREAM_ADDRESS = "192.168.188.42"; // cranberry.uniks.de
